/* ════════════════════════════════════════════════════
   explore.js — Página pública de SoundMind
   - Catálogo completo con imágenes.
   - Reproductor funcional (global, sin contexto de sesión).
   - Búsqueda manual, filtro por género.
   - Funciones bloqueadas: voz, likes, favoritos.
════════════════════════════════════════════════════ */
...
/* ═══════════════════ REPRODUCTOR (similar al original) ══════════════════ */
...
function onAudioEnded() {
  ...
  $('expDisc')?.classList.remove('spinning');
  $('expPlayPauseBtn').textContent = '▶';
  // Siguiente canción en orden global
  playNextSong();
}
